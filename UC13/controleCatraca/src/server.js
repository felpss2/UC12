...
app.post('/create-cliente', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nome, cpf, horarioEntrada, horarioSaida, newCliente, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, nome = _a.nome, cpf = _a.cpf;
